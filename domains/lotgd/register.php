...
// Load the register.php language file
require PUN_ROOT.'lang/'.$pun_user['language'].'/register_game.php';

// Load the functions script
require PUN_ROOT.'include/functions_game.php';
...
if (isset($_POST['form_sent']))
{
	...
	// Character
	$charname = pun_trim($_POST['req_charname']);
...
$required_fields = array('req_user' => $lang_common['Username'], 'req_password1' => $lang_common['Password'], 'req_password2' => $lang_prof_reg['Confirm pass'], 'req_email1' => $lang_common['Email'], 'req_email2' => $lang_common['Email'].' 2', 'req_charname' => $lang_register_game['Charname']);
...
<?php endif; ?>					</div>
			...
			<div class="inform">
				<fieldset>
					<legend><?php echo $lang_register_game['Char legend'] ?></legend>
					<div class="infldset">
						<label class="required"><strong><?php echo $lang_register_game['Charname'] ?> <span><?php echo $lang_common['Required'] ?></span></strong><br /><input type="text" name="req_charname" value="<?php if (isset($_POST['req_charname'])) echo pun_htmlspecialchars($_POST['req_charname']); ?>" size="25" maxlength="25" /> <span><a target="_blank" href="https://randomall.ru/fantasy_name/"><?php echo $lang_register_game['Charname generator'] ?></a></span><br /></label>
						<p><span><?php echo $lang_register_game['Charname legend'] ?></span></p>
					<label><?php echo $lang_register_game['Chargender'] ?><br />
					<select name="chargender">					
						<option value="0" selected="selected"><?php echo $lang_register_game['Male'] ?></option>
						<option value="1"><?php echo $lang_register_game['Female'] ?></option>
					</select>					
					</div>
				</fieldset>
			</div>
